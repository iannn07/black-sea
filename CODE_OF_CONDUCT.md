...
responsible for enforcement privately through GitHub — either the repository's **Security → Report a
vulnerability** advisory form (<https://github.com/iannn07/black-sea/security/advisories/new>) or a
direct message to the maintainer (**@iannn07**). All complaints will be reviewed and investigated
promptly and fairly.
